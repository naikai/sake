...
Example saved data can be downloaded [here](../data/Treutlein.NMF5.rda)
...
<img src="Figures/Treutlein/Gene_network.png" width="400px" height="420px" />
...
<img src="Figures/Treutlein/Scatter_plot.png" width="700px" height="450px" />
...
An example result is shown below for the consensus plots and distributions of cophenetic coefficients and silhouette index for different values of K using a published single-cell RNA-seq dataset^[Treutlein *et al*, Dissecting direct reprogramming from fibroblast to neuron using single-cell RNA-seq, Nature, 2016] is displayed below. In this case, the estimated number of clusters present in the data is **5**, as indicated by the consensus plots, cophenetic coefficients, and silhouette index. 

<img src="./Figures/Treutlein/NMF_Treutlein_EstimK_consensus.png" width="800px" height="600px" />
<img src="./Figures/Treutlein/NMF_Treutlein_EstimK_stats.png" width="800px" height="600px" />

*Note: It takes around 25 minutes to run 20 iterations for each value of K on a MacBook Pro (Retina, 15-inch, Mid 2015), 2.5 GHz Intel Core i7, with 16 GB 1600 MHz DDR3*
...
<img src="./Figures/Treutlein/NMF_Treutlein_K5_Feature.png" width="800px" height="500px" />  
...
SAKE provides t-SNE plots both in 2-D and 3-D for users to better understand the clustering results. 

<img src="Figures/Treutlein/NMF_Treutlein_K5_t-SNE_NMF.png" width="700px" height="350px" />
...
<img src="Figures/Treutlein/NMF_Treutlein_K5_t-SNE_Filename.png" width="700px" height="400px" />
...
We will demonstrate by plotting *`Syp`* (Neuronal marker) and *`Tnnc2`* (Myocyte marker) according to Treutlein et al, 2016.  

`Syp` is enriched in `NMF group5`, whereas most of the samples in this group are marked as induced neurons in original published results. 

<img src="Figures/Treutlein/NMF_Treutlein_K5_t-SNE_Syp.png" width="700px" height="400px" />

`Tnnc2` is enriched in `NMF group1`, `NMF group3` and `NMF group4`, whereas most of the samples in these groups are marked as myocytes in original published results. 

<img src="Figures/Treutlein/NMF_Treutlein_K5_t-SNE_Tnnc2.png" width="700px" height="400px" />
...
<img src="Figures/Treutlein/NMF_Treutlein_K5_PCA.png" width="700px" height="350px" />
...
Based on these criteria for the samples displayed below, NMF group5 contained samples with lower levels of heterogeneity. A majority of the cells in NMF group5 were identified as deriving from a single cell type in the original author's publication (Neuron), whereas cells in NMF group1, group2, and group3 were identified as deriving from mixture cell types (Treutlein et al., 2016).   

<img src="Figures/Treutlein/NMF_Treutlein_K5_groupstats.png" width="800px" height="270px" />
...
In this case, we will select **Mouse** for data from Treutlein et al. 

<img src="Figures/Treutlein/NMF_Treutlein_K5_Enrich_Sel_Mouse.png" width="800px" height="450px" />

Summary table and plots for the enrichment analysis. 

<img src="Figures/Treutlein/NMF_Treutlein_K5_Enrich_Res.png" width="800px" height="400px" />

User can also click on one of the enriched KEGG pathways they are interested in. [Pathview](https://bioconductor.org/packages/release/bioc/html/pathview.html) will maps and renders pathway grpahs. In this case, we select `Synaptic vesicle cycle` from `NMF Group5`. According to annotation from the original authoer's publication, most of the cells in this groups are Neurons. Red color indicates genes that are upregulated in selected NMF cluster as compared to all the other clusters. 

<img src="Figures/Treutlein/NMF_Treutlein_K5_Enrich_Pathview.png" width="800px" height="500px" />
